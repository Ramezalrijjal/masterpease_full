...
<head>
    ...
    <link href="{{ asset('booking.css') }}" rel="stylesheet">
    ...
    <div class="container">
       ...
       {{-- <h1> {{$service->name}}</h1> --}}
            <form action="{{route('payment',$service->id)}}" method="POST">
                @csrf
                <label for="tripName">Tour Name:</label>
                <input type="text" id="tripName" name="tripName" value="{{$service->name}}" required>
                <label for="tripPrice">Price:</label>
                <input type="number" id="tripPrice" name="tripPrice" value="{{$service->price}}" required>
                <label for="tripDate">Tour Date:</label>
                <input type="date" id="tripDate" name="tripDate" required>
                <label for="numAdults">Number of Adults:</label>
                <input type="number" id="numAdults" name="numAdults" required>
                ...
                <label for="userEmail">Email Address:</label>
                <input type="email" id="userEmail" name="userEmail" value="{{ Auth::user()->email }}" required>
